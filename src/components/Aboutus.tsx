...
function TeamCard({ name, role, image, size, index = false }: TeamCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`
        relative bg-white/80 border border-gray-400 dark:border-0 dark:bg-slate-800/20 backdrop-blur-xl 
      ...
      >
        ...
        <div className="relative z-10 flex justify-center mb-6">
          <div
            className={`
            relative ${index ? "w-56 h-56" : "w-52 h-52"} 
        ...
        <div className="relative z-10 text-center">
          <h3
            className={`
            font-bold text-black/70 dark:text-white mb-2 transition-colors duration-300
            ${index ? "text-2xl" : "text-2xl"}
     ...
     <section className="team-gradient-bg min-h-screen py-20 relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <h2 className="text-6xl md:text-7xl font-black text-black/70 dark:text-white mb-6 tracking-tight">
        ...
        {/* Mentors Section */}
        <div className="mb-20">
          <h3 className="text-4xl font-bold text-center dark:text-white mb-12">
        ...
        {/* Core Team Section */}
        <div>
          <h3 className="text-4xl font-bold text-center text-black/70 dark:text-white mb-12">
