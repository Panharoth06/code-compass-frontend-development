      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6" style={{ fontFamily: '"Source Code Pro", monospace' }}>
            <span className="bg-gradient-to-r from-[#CCF301] via-[#000000] to-[#CCF301] dark:from-[#CCF301] dark:via-white dark:to-[#CCF301] bg-[length:200%_100%] bg-clip-text text-transparent animate-gradient-x">
              Why Choose
            </span>
            <br />
            <span className="bg-gradient-to-r from-[#CCF301] via-[#000000] to-[#CCF301] dark:from-[#CCF301] dark:via-white dark:to-[#CCF301] bg-[length:200%_100%] bg-clip-text text-transparent animate-gradient-x">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 mb-6 relative">
                <div className="w-16 h-16 bg-gradient-to-br from-[#CCF301] to-[#CCF301]/70 rounded-2xl flex items-center justify-center group-hover:scale-105 group-hover:rotate-1 transition-all duration-500 ease-out shadow-lg group-hover:shadow-xl group-hover:shadow-[#CCF301]/25">
              ...
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-[#CCF301] transition-colors duration-500" style={{ fontFamily: '"Source Code Pro", monospace' }}>
                Powerful Editor
              </h4>
