...
const OrbitingAnimation = ({ isDarkMode = false }) => {
  ...
  <div className={`absolute rounded-full border opacity-30 w-[440px] h-[440px] animate-pulse-slow`} 
       style={{ 
         animationDelay: '1s',
         borderColor: isDarkMode ? '#CCF301' : '#000000'
       }}></div>
  <div className={`absolute rounded-full border opacity-30 w-[320px] h-[320px] animate-pulse-slow`} 
       style={{ 
         animationDelay: '2s',
         borderColor: isDarkMode ? '#CCF301' : '#000000'
       }}></div>
  <div className={`absolute rounded-full border opacity-30 w-[200px] h-[200px] animate-pulse-slow`} 
       style={{ 
         animationDelay: '3s',
         borderColor: isDarkMode ? '#CCF301' : '#000000'
       }}></div>
