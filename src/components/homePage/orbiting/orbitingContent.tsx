...
const OrbitingContent: React.FC<OrbitingContentProps> = ({ isDarkMode }) => {
  ...
  const isVisible = (item: string) => visibleItems.has(item);
    ...
    <div className="order-2 lg:order-2 space-y-4">
      ...
      >
        ...
        >
          ...
          Problems <span className="text-lime-400">Your Way!</span>
        </h3>
      </div>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h5 className="text-lg font-semibold mb-2 group-hover:text-lime-400 transition-colors duration-300">
                Problem Sets
              </h5>
              <p
              ...
              >
                Sharpen your skills in Java, widely used in enterprise
                applications, Android development, and scalable systems.
              </p>
            </div>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              >
                Solve coding problems in Python, the most beginner-friendly
                language with powerful libraries for data science, AI, and
                automation.
              </p>
            </div>
            <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-0 group-hover:translate-x-1 text-lime-400">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              >
                Master C, the foundation of programming that teaches you memory
                management, performance, and low-level concepts.
              </p>
            </div>
            <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-0 group-hover:translate-x-1 text-lime-400">
              <svg
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              >
                Level up with JavaScript, the language of the web, powering
                interactive websites, front-end frameworks, and full-stack apps.
              </p>
            </div>
            <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-0 group-hover:translate-x-1 text-lime-400">
              <svg
