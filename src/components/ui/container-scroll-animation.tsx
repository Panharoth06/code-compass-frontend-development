...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="mt-28 lg:mt-0 lg:h-[80rem] flex items-center justify-center relative p-2 md:p-10"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-7xl -mt-6 mx-auto w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
      <div className="sm:h-full w-full overflow-hidden rounded-2xl bg-zinc-900 md:rounded-2xl">
        {children}
      </div>
    </motion.div>
  );
